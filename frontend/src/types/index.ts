...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kiro' | 'codebuddy' | 'kimi' | 'zhipu' | 'deepseek' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kiro' | 'codebuddy' | 'kimi' | 'zhipu' | 'deepseek'

export default {
    accounts: {
      ...
      dataImportWarning: '导入将创建新账号与代理；可在下方预选分组与代理，一步绑定。',
      dataImportFile: '数据文件',
      importPreGroup: '预分组',
      importPreGroupHint: '导入后账号直接加入所选分组；若分组配置了默认代理且未指定代理，将自动绑定。',
      importPreProxy: '默认代理（可选）',
      importPreProxyHint: '覆盖文件中的代理；留空则保留文件 proxy 或使用分组默认代理。',
      importApplyDefaultProxy: '无代理时使用分组默认代理',
      importPreEditTitle: '导入前按类型预编辑',
      importPreEditHint: '已解析 {count} 个账号；勾选后按平台覆盖对应字段，再开始导入。',
      importPreEditCount: '{count} 个',
      importPreEditUnnamed: '未命名 #{index}',
      importPreEditMore: '…另有 {count} 个',
      importPreEditNamePrefix: '名称前缀',
      importPreEditNamePrefixPh: '例如 prod-',
      importPreEditNameSuffix: '名称后缀',
      importPreEditNameSuffixPh: '例如 -pool',
      importPreEditNotesPh: '导入后统一备注',
      importScopeLabel: '预获取范围',
      importScopeFirst: '仅第一个',
      importScopeAll: '全部账号',
      importScopeFirstHint: '文件共 {total} 个账号，仅导入列表中的第一个，便于试通配置。',
      importScopeAllHint: '将导入全部 {total} 个账号。',
      ...
      types: {
        ...
        grokConsole: 'Console 会话（SSO + DPoP）',
        grokWeb: 'Web 会话（SSO + cf_clearance）',
      ...
      grokSession: {
        ssoToken: 'SSO Token',
        ssoPlaceholder: '粘贴 sso cookie 值（sso= 后面的部分）',
        cfClearance: 'cf_clearance',
        cfPlaceholder: '粘贴 cf_clearance cookie 值',
        userAgent: '浏览器 User-Agent',
        userAgentPlaceholder: '必须与获取 SSO/cf_clearance 的浏览器一致',
        selectProxy: '请选择出口代理',
        proxyHint: '会话与代理绑定：更换代理后需重新导入会话材料。',
        consoleHint: 'Console 账号通过 DPoP 访问 console.x.ai，支持 Responses/图像/视频/TTS/STT。SSO 仅在提交时发送一次，保存后不再回显。',
        webHint: 'Web 账号通过 mgw WebSocket 访问 grok.com，支持聊天与搜索；模型可用性取决于订阅档位。SSO 与 cf_clearance 仅在提交时发送一次，保存后不再回显。',
        ssoRequired: '请填写 SSO Token',
        cfRequired: '请填写 cf_clearance',
        uaRequired: '请填写浏览器 User-Agent',
        proxyRequired: '请选择出口代理',
        created: 'Grok 会话账号创建成功',
        createFailed: 'Grok 会话账号创建失败'
      },
      codebuddyCredits: '积分余额',
      codebuddyLoginTitle: 'CodeBuddy 登录',
      codebuddyLoginButton: 'CodeBuddy 登录',
      codebuddyLoginDesc: '选择区域后点击开始，跳转到腾讯 CodeBuddy 授权页完成登录，然后回到这里创建账号。也可粘贴 workbuddy auths JSON 批量导入。',
      codebuddyLoginNamePlaceholder: '留空则自动使用昵称 / UID 推导账号名',
      codebuddyLoginRegion: '区域',
      codebuddyRegionCN: '国内版（codebuddy.cn）',
      codebuddyRegionCNDesc: 'copilot.tencent.com，含签到活动',
      codebuddyRegionGlobal: '国际版（workbuddy.ai）',
      codebuddyRegionGlobalDesc: '无签到活动，模型与国内版不互通',
      codebuddyLoginSectionTitle: '浏览器授权',
      codebuddyLoginSectionDesc: '点击开始登录，在浏览器完成 CodeBuddy 授权后回到这里等待授权完成。',
      codebuddyLoginStartButton: '开始 CodeBuddy 登录',
      codebuddyLoginRestartButton: '重新开始 CodeBuddy 登录',
      codebuddyLoginStartSuccess: 'CodeBuddy 授权已开始',
      codebuddyLoginStartFailed: '启动 CodeBuddy 登录失败',
      codebuddyLoginOpenPageButton: '打开授权页',
      codebuddyLoginCheckStatusButton: '检查授权状态',
      codebuddyLoginPolling: '轮询中...',
      codebuddyLoginBrowserHint: '在浏览器完成登录前，状态会保持“等待授权”。可随时点击“检查授权状态”。',
      codebuddyLoginStatus: '状态',
      codebuddyLoginAccount: '账号',
      codebuddyLoginAuthorized: '授权完成',
      codebuddyLoginPendingStatus: '等待授权',
      codebuddyLoginPollingStatus: '正在查询...',
      codebuddyLoginNotStartedStatus: '未开始',
      codebuddyLoginAuthorizedSuccess: 'CodeBuddy 授权完成',
      codebuddyLoginPollFailed: '查询 CodeBuddy 授权状态失败',
      codebuddyLoginAuthorizeFirst: '请先完成 CodeBuddy 授权',
      codebuddyLoginCreateButton: '创建账号',
      codebuddyLoginCreateSuccess: 'CodeBuddy 账号创建成功',
      codebuddyLoginCreateFailed: '创建 CodeBuddy 账号失败',
      codebuddyImportTitle: '批量导入（auths JSON）',
      codebuddyImportPayload: 'auths JSON 内容',
      codebuddyImportPayloadPlaceholder: '粘贴 workbuddy2api 的 auths/*.json 内容（嵌套形或扁平形），支持数组批量导入',
      codebuddyImportPayloadHint: '区域以上方选择为准；导入的每个账号都会写入对应区域的模型目录。',
      codebuddyImportPayloadRequired: '请粘贴 auths JSON 内容',
      codebuddyImportButton: '导入账号',
      codebuddyImportSuccess: '导入完成：成功 {created} 个，失败 {failed} 个',
      codebuddyImportFailed: '导入 CodeBuddy 账号失败',
      kiroLoginTitle: 'Kiro 浏览器登录',
      kiroLoginButton: 'Kiro 浏览器登录',
      ...
      kiroLoginRestartButton: '重新开始 Kiro 登录',
      kiroLoginStartSuccess: 'Kiro 授权已开始',
      kiroLoginStartFailed: 'Kiro 授权启动失败',
      kiroLoginUserCode: '用户代码',
      kiroLoginStatus: '状态',
      kiroLoginPendingStatus: '等待授权中',
      kiroLoginPollingStatus: '正在检查授权状态',
      kiroLoginAuthorized: '已授权',
      kiroLoginNotStartedStatus: '未开始',
      kiroLoginOpenPageButton: '打开授权页面',
      kiroLoginCheckStatusButton: '检查状态',
      kiroLoginPolling: '检查中...',
      kiroLoginPollFailed: '检查 Kiro 授权状态失败',
      kiroLoginAuthorizedSuccess: 'Kiro 授权已完成',
      kiroLoginAuthorizeFirst: '请先完成 Kiro 浏览器授权',
      kiroLoginBrowserHint: '不要在这里粘贴 token 或回调数据，只需在打开的 Builder ID 页面完成登录授权。',
      kiroLoginAdvancedImportTitle: '高级导入 / 粘贴 JSON 兜底',
      kiroLoginPayload: '登录结果 JSON',
      kiroLoginPayloadPlaceholder: '粘贴包含 refresh_token/access_token/profile_arn 等字段的 Kiro 登录结果 JSON...',
      kiroLoginPayloadHint: '支持 credentials、external_idp、subscription、usage 等嵌套字段。',
      kiroLoginPayloadRequired: '请先粘贴 Kiro 登录结果 JSON',
      kiroLoginPreview: '识别结果',
      kiroLoginPreviewButton: '预览',
      kiroLoginPreviewFailed: 'Kiro 登录结果预览失败',
      kiroLoginImportButton: '从 JSON 导入',
      kiroLoginImportSuccess: '已通过 JSON 导入 Kiro 账号',
      kiroLoginCreateButton: '创建 Kiro 账号',
      kiroLoginCreateSuccess: 'Kiro 账号创建成功',
      kiroLoginCreateFailed: 'Kiro 账号创建失败',
      kiroApiKeyEntryTitle: 'Kiro API Key',
      kiroApiKeyEntryDesc: '使用 ksk_ 前缀 API Key 创建，不支持 token 刷新。',
      kiroApiKeyLabel: 'Kiro API Key *',
      kiroApiKeyPlaceholder: 'ksk_...',
      kiroApiKeyHint: '必须以 ksk_ 开头。创建后不会再回显完整密钥。',
      kiroApiKeyRequired: '请输入 Kiro API Key',
      kiroApiKeyInvalidPrefix: 'Kiro API Key 必须以 ksk_ 开头',
      kiroApiKeyNoRefresh: 'API Key 账号不支持 token 刷新。',
      kiroEndpoint: 'Endpoint',
      kiroEndpointHint: 'API Key 账号仅支持 CLI endpoint。',
      kiroApiRegion: 'API 区域',
      kiroApiRegionHint: '默认 us-east-1。',
      kiroAuthRegion: '认证区域',
      ...
      bulkActions: {
        ...
        delete: '批量删除',
        batchTest: '批量测活',
        batchTestFiltered: '按筛选测活',
        batchTestGroup: '按分组测活',
        batchTestFilteredHint: '对当前筛选条件下的账号执行测活（最多 100 个）',
        editGroup: '批量编辑分组',
        editFilteredHint: '统一更新当前筛选/分组下账号的勾选字段',
      ...
      batchTest: {
        ...
        emptyFilter: '当前筛选下没有可测活的账号',
        capped: '当前筛选共 {total} 个账号，将测活前 {count} 个（单次上限）',
        loadFailed: '加载筛选账号失败',
        retryFailed: '重测异常账号',
        deleteFailed: '删除异常账号',
        deleteAllFailed: '删除全部异常',
        deleteSelectedFailed: '删除选中异常',
        deletingFailed: '删除中...',
        deleteFailedConfirm: '确认删除本次测活失败的 {count} 个账号？',
        selectedFailedCount: '已选中 {selected}/{total} 个异常账号',
        allFailedTab: '全部异常 {count}',
        failureTab: '{code} {count}',
        selectFilteredFailed: '选中当前筛选',
        selectAllFailed: '全选异常',
        invertFailedSelection: '反选',
        select: '选择',
        preselectStatus: '先按状态筛选本次测活',
        preselectStatusHint: '状态筛选后剩余 {count} 个账号',
        proxyOverride: '测活出口代理',
        proxyOverrideHint: '从 IP 管理加载；默认保持各账号已绑定出口（Grok 若在系统设置启用了 ops 出口，则未显式选择时走 ops）。选择后仅本次测活临时走该出口，不改账号绑定。',
        proxyOverrideKeepBound: '保持账号绑定出口',
        proxyOverrideDirect: '强制直连（无代理）',
        proxyOverrideLoadFailed: '加载代理列表失败，仍可保持账号绑定出口测活',
        proxyOverrideSearch: '搜索代理名称 / host',
        noProxy: '无代理（直连）',
        proxyLabel: '代理 #{id}',
        ...
        readyCountHint: '按当前状态筛选，将测活 {count} 个账号。',
        grokRiskHint: 'Grok 批量测活会真实请求上游，数量较大时建议缩小批次并保持串行间隔。',
        startConfirm: '确认开始测活？\n账号：{count}\n出口：{proxy}\n间隔：{interval}s\n并发：{concurrency}\n模式：{mode}',
        postActionsTitle: '测活结束后的状态设置',
        postActionsHint: '对本次测活成功的 {count} 个账号执行操作',
        enableSuccessful: '成功账号立即启用',
        activateSuccessful: '成功账号设为正常',
        enableSchedulingSuccessful: '成功账号启用调度',
        applyingStatus: '应用中...',
      },
      bulkEdit: {
        title: '批量编辑账号',
        ...
        syncUpstreamHint: '从各账号上游拉取实时模型目录并并入该账号的模型映射（只新增，不删除已有模型），逐账号独立处理，单个失败不影响其它账号。',
        syncUpstreamSuccess: '已同步 {count} 个账号的上游模型，共新增 {added} 个模型。',
        syncUpstreamNoChanges: '上游 {count} 个账号的模型均已存在，无需更新。',
        syncUpstreamPartial: '同步完成：成功 {success} 个，失败 {failed} 个。',
        syncUpstreamFailed: '同步上游模型失败，请稍后重试。',
      ...
      account: '账号',
      testProxyOverride: '测活出口代理',
      testProxyOverrideHint: '从 IP 管理加载；默认保持账号已绑定出口（Grok 若在系统设置启用了 ops 出口，则未显式选择时走 ops）。选择后仅本次测活临时走该出口，不改账号绑定。',
      testProxyOverrideKeepBound: '保持账号绑定出口',
      testProxyOverrideDirect: '强制直连（无代理）',
      testProxyOverrideLoadFailed: '加载代理列表失败，仍可保持账号绑定出口测活',
      testProxyOverrideSearch: '搜索代理名称 / host',
      testProxyLabel: '代理 #{id}',
      ...
      usingEgressIP: '出口 IP：{ip} ({ms}ms)',
      testDirect: '直连（无代理）',
      egressProbeFailed: '出口探测失败：{error}',

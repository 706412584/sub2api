export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      kiroImportDesc: '导入 Kiro 账号数据，支持原始 JSON 数组、Kiro Account Manager 包装数据和企业 external_idp JSON。',
      kiroImportButton: '导入 Kiro 账号',
      kiroImportResult: '导入结果',
      kiroImportResultSummary: '共 {total} 个，创建 {created}，失败 {failed}',
      kiroImportSuccess: 'Kiro 账号导入完成：创建 {created}，失败 {failed}',
      kiroImportFailed: 'Kiro 账号导入失败',
      kiroImportPasteLabel: '或粘贴 JSON',
      kiroImportPastePlaceholder: '粘贴单个账号、数组或 Kiro Account Manager 导出的 JSON...',
      kiroImportPasteEmpty: '请先粘贴至少一份 JSON 内容',
      kiroImportSourceHint: '选择文件，或在下方粘贴 JSON，二者择一即可。',
      ...
      kiroLoginPayloadHint: '支持 credentials、external_idp、subscription、usage 等嵌套字段；批量数据请使用“导入 Kiro 账号”。',
      ...
      grokOAuthTitle: 'Grok OAuth 登录',
      grokOAuthButton: 'Grok OAuth 登录',
      grokOAuthEntryDesc: '使用 xAI OAuth 授权码 + PKCE 创建账号。',
      grokOAuthDesc: '使用 xAI OAuth 授权码 + PKCE 登录。点击开始登录，在打开的 xAI 页面完成授权后，把回跳地址或 code 粘贴回来创建 Grok OAuth 账号。',
      grokOAuthNamePlaceholder: '留空则自动使用 xAI 账号信息',
      grokOAuthRedirectUri: '回调地址',
      grokOAuthRedirectUriHint: '保持默认即可；授权完成后浏览器可能显示无法访问 localhost，复制地址栏完整 URL 粘贴回来。',
      grokOAuthStartButton: '开始 Grok 登录',
      grokOAuthOpenAgain: '重新打开授权页',
      grokOAuthStartFailed: 'Grok 授权页生成失败',
      grokOAuthCallbackTitle: '粘贴授权回调',
      grokOAuthCallbackHint: '授权后复制浏览器地址栏中的完整回调 URL，或只复制 code 参数。不要粘贴 access_token。',
      grokOAuthCallbackPlaceholder: 'http://127.0.0.1:56121/callback?code=...&state=... 或只粘贴 code',
      grokOAuthCallbackRequired: '请先粘贴 Grok 授权回调 URL 或 code',
      grokOAuthStateMismatch: '授权回调 state 不匹配，请重新开始 Grok 登录',
      grokOAuthCreateButton: '创建 Grok 账号',
      grokOAuthCreateSuccess: 'Grok 账号创建成功',
      grokOAuthCreateFailed: 'Grok OAuth 登录失败',
      grokTokenTitle: 'Grok 手动 Token',
      grokTokenButton: 'Grok 手动 Token',
      grokTokenEntryDesc: '作为备用方式，粘贴已有 Grok/xAI token JSON。',
      grokTokenDesc: '粘贴单个 Grok/xAI token JSON，系统会规范化支持的 token 字段并创建 Grok OAuth 账号。',
      grokTokenNamePlaceholder: '留空则自动使用显示名、用户名、邮箱或 subject',
      grokTokenPayload: 'Token JSON',
      grokTokenPayloadPlaceholder: '粘贴包含 access_token/accessToken，以及可选 refresh_token、expires_at、api_base_url、用户信息等字段的 JSON...',
      grokTokenPayloadHint: '支持直接对象，以及 data.credentials、data.token、data.user 等常见嵌套对象。',
      grokTokenPayloadRequired: '请先粘贴 Grok token JSON',
      grokTokenPreview: '识别结果',
      grokTokenPreviewButton: '预览',
      grokTokenPreviewFailed: 'Grok token 预览失败',
      grokTokenCreateButton: '创建 Grok 账号',
      grokTokenCreateSuccess: 'Grok 账号创建成功',
      grokTokenCreateFailed: 'Grok 账号创建失败',
      syncErrors: '错误/跳过详情',
      ...
      grokComingSoon: '请选择下方 Grok OAuth 登录创建账号；手动 Token 仅作为备用方式。',
      grokUseTokenEntry: '请选择下方添加方式',
      types: {
        oauth: 'OAuth',
      ...
      batchTest: {
        ...
        retryFailed: '重测异常账号',
        deleteFailed: '删除异常账号',
        deleteAllFailed: '删除全部异常账号',
        deleteSelectedFailed: '删除选中异常账号',
        deletingFailed: '删除中...',
      ...
      batchScheduledTest: {
        ...
        submit: '保存定时测活',
        submitting: '保存中...',
        summary: '新增：{created} / 更新：{updated} / 失败：{failed}',
        accountName: '账号名',
        action: '结果',
        error: '错误',
        created: '已新增',
      ...
      oauth: {
        ...
        gemini: {
          ...
          aiStudioNotConfiguredTip:
            'AI Studio OAuth 未配置：请先设置 GEMINI_OAUTH_CLIENT_ID / GEMINI_OAUTH_CLIENT_SECRET，并在 Google OAuth Client 添加 Redirect URI：http://127.0.0.1:56121/callback（Consent Screen scopes 需包含 https://www.googleapis.com/auth/generative-language.retriever）',
          aiStudioNotConfigured:
            'AI Studio OAuth 未配置：请先设置 GEMINI_OAUTH_CLIENT_ID / GEMINI_OAUTH_CLIENT_SECRET，并在 Google OAuth Client 添加 Redirect URI：http://127.0.0.1:56121/callback'
        },
    ...
    proxies: {
      ...
      batchInputHint: "支持 http、https、socks5 协议，格式：协议://[用户名:密码{'@'}]主机:端口，或供应商格式 协议://主机:端口:用户名:密码",
    ...
    settings: {
      ...
      site: {
        ...
        updateProxyUrl: '更新下载代理 URL',
        updateProxyUrlHint: '用于检查和下载 GitHub Release 更新；留空则使用配置文件 update.proxy_url。',
        updateProxyUrlPlaceholder: '例如 socks5h://127.0.0.1:1080 或 http://127.0.0.1:7890',

export default {
    settings: {
      ...
      grokReasoningVisibility: {
        ...
        probeAccountFallback: 'Allow unprobed accounts',
        probeAccountFallbackHint: 'When enabled, accounts that have not been probed yet are not excluded (fail-open).',
      ...
      grokCliIdentity: {
        ...
        pinnedDefault: 'Compile default',
        settingsOverride: 'Settings override',
        envOverride: 'Env override',
        source: 'Source',
        sourceSettings: 'Settings',
        sourceEnv: 'Environment',
        sourceDefault: 'Compile default',
        latest: 'npm latest',
        latestCheckedAt: 'Checked at',
        updateAvailable: 'Update available',
        versionInput: 'Manual override version',
        versionInputHint: 'Canonical semver at or above compile default; clear and save to remove override',
        check: 'Check for updates',
        checking: 'Checking…',
        applyLatest: 'Apply latest',
        applying: 'Applying…',
        restoreDefault: 'Restore compile default',
        restoring: 'Restoring…',
        save: 'Save override',
        saving: 'Saving…',
        none: 'None',
        checkOk: 'Checked npm latest',
        checkFailed: 'Failed to check npm latest',
        applyOk: 'Applied npm latest',
        applyFailed: 'Failed to apply npm latest',
        restoreOk: 'Restored compile default',
        restoreFailed: 'Failed to restore compile default',
        saved: 'Grok CLI identity version saved',
        saveFailed: 'Failed to save Grok CLI identity version'
      },
      accountPoolProbe: {

export default {
    accounts: {
      ...
      importPreGroup: 'Pre-assign groups',
      importPreGroupHint: 'Imported accounts join selected groups. Group default proxy applies when no proxy is set.',
      importPreProxy: 'Default proxy (optional)',
      importPreProxyHint: 'Overrides file proxy when set; leave empty to keep file proxy or group default.',
      importApplyDefaultProxy: 'Use group default proxy when unset',
      importPreEditTitle: 'Pre-edit by account type',
      importPreEditHint: 'Parsed {count} account(s). Enable fields to override by platform before import.',
      importPreEditCount: '{count}',
      importPreEditUnnamed: 'Unnamed #{index}',
      importPreEditMore: '…and {count} more',
      importPreEditNamePrefix: 'Name prefix',
      importPreEditNamePrefixPh: 'e.g. prod-',
      importPreEditNameSuffix: 'Name suffix',
      importPreEditNameSuffixPh: 'e.g. -pool',
      importPreEditNotesPh: 'Notes applied to all in this type',
      importScopeLabel: 'Import scope',
      importScopeFirst: 'First only',
      importScopeAll: 'All accounts',
      importScopeFirstHint: '{total} account(s) found; import only the first to validate settings.',
      importScopeAllHint: 'Import all {total} account(s).',
      ...
      types: {
        ...
        grokConsole: 'Console session (SSO + DPoP)',
        grokWeb: 'Web session (SSO + cf_clearance)',
      ...
      grokSession: {
        ssoToken: 'SSO Token',
        ssoPlaceholder: 'Paste the sso cookie value (the part after sso=)',
        cfClearance: 'cf_clearance',
        cfPlaceholder: 'Paste the cf_clearance cookie value',
        userAgent: 'Browser User-Agent',
        userAgentPlaceholder: 'Must match the browser used to obtain SSO/cf_clearance',
        selectProxy: 'Select an egress proxy',
        proxyHint: 'Sessions are bound to a proxy: re-import session materials after changing it.',
        consoleHint: 'Console accounts reach console.x.ai via DPoP, supporting Responses/images/video/TTS/STT. The SSO is sent once on submit and never echoed back.',
        webHint: 'Web accounts reach grok.com via the mgw WebSocket, supporting chat and search; model availability depends on subscription tier. SSO and cf_clearance are sent once on submit and never echoed back.',
        ssoRequired: 'SSO token is required',
        cfRequired: 'cf_clearance is required',
        uaRequired: 'Browser User-Agent is required',
        proxyRequired: 'An egress proxy is required',
        created: 'Grok session account created',
        createFailed: 'Failed to create Grok session account'
      },
      codebuddyCredits: 'Credits',
      codebuddyLoginTitle: 'CodeBuddy Login',
      codebuddyLoginButton: 'CodeBuddy Login',
      codebuddyLoginDesc: 'Pick a region, start the flow, complete authorization on the CodeBuddy page, then create the account here. You can also paste workbuddy auths JSON for batch import.',
      codebuddyLoginNamePlaceholder: 'Leave blank to derive the account name from nickname / UID',
      codebuddyLoginRegion: 'Region',
      codebuddyRegionCN: 'CN (codebuddy.cn)',
      codebuddyRegionCNDesc: 'copilot.tencent.com, with check-in activity',
      codebuddyRegionGlobal: 'Global (workbuddy.ai)',
      codebuddyRegionGlobalDesc: 'No check-in activity; models not shared with CN',
      codebuddyLoginSectionTitle: 'Browser authorization',
      codebuddyLoginSectionDesc: 'Start the flow, complete CodeBuddy login in the browser, then return here and wait for authorization.',
      codebuddyLoginStartButton: 'Start CodeBuddy Login',
      codebuddyLoginRestartButton: 'Restart CodeBuddy Login',
      codebuddyLoginStartSuccess: 'CodeBuddy authorization started',
      codebuddyLoginStartFailed: 'Failed to start CodeBuddy login',
      codebuddyLoginOpenPageButton: 'Open authorization page',
      codebuddyLoginCheckStatusButton: 'Check status',
      codebuddyLoginPolling: 'Polling...',
      codebuddyLoginBrowserHint: 'Status stays "waiting for authorization" until you finish the login in the browser. You can click "Check status" at any time.',
      codebuddyLoginStatus: 'Status',
      codebuddyLoginAccount: 'Account',
      codebuddyLoginAuthorized: 'Authorized',
      codebuddyLoginPendingStatus: 'Waiting for authorization',
      codebuddyLoginPollingStatus: 'Checking...',
      codebuddyLoginNotStartedStatus: 'Not started',
      codebuddyLoginAuthorizedSuccess: 'CodeBuddy authorization completed',
      codebuddyLoginPollFailed: 'Failed to poll CodeBuddy authorization status',
      codebuddyLoginAuthorizeFirst: 'Complete CodeBuddy authorization first',
      codebuddyLoginCreateButton: 'Create account',
      codebuddyLoginCreateSuccess: 'CodeBuddy account created',
      codebuddyLoginCreateFailed: 'Failed to create CodeBuddy account',
      codebuddyImportTitle: 'Batch import (auths JSON)',
      codebuddyImportPayload: 'auths JSON content',
      codebuddyImportPayloadPlaceholder: 'Paste workbuddy2api auths/*.json content (nested or flat); arrays are imported in batch',
      codebuddyImportPayloadHint: "The region selected above applies; every imported account gets that region's model catalog.",
      codebuddyImportPayloadRequired: 'Please paste the auths JSON content',
      codebuddyImportButton: 'Import accounts',
      codebuddyImportSuccess: 'Import finished: {created} created, {failed} failed',
      codebuddyImportFailed: 'Failed to import CodeBuddy accounts',
      kiroLoginTitle: 'Kiro Browser Login',
      kiroLoginButton: 'Kiro Browser Login',
      ...
      kiroLoginRestartButton: 'Restart Kiro Login',
      kiroLoginStartSuccess: 'Kiro authorization started',
      kiroLoginStartFailed: 'Failed to start Kiro authorization',
      kiroLoginUserCode: 'User code',
      kiroLoginStatus: 'Status',
      kiroLoginPendingStatus: 'Waiting for authorization',
      kiroLoginPollingStatus: 'Checking authorization status',
      kiroLoginAuthorized: 'Authorized',
      kiroLoginNotStartedStatus: 'Not started',
      kiroLoginOpenPageButton: 'Open Authorization Page',
      kiroLoginCheckStatusButton: 'Check Status',
      kiroLoginPolling: 'Checking...',
      kiroLoginPollFailed: 'Failed to check Kiro authorization status',
      kiroLoginAuthorizedSuccess: 'Kiro authorization completed',
      kiroLoginAuthorizeFirst: 'Complete Kiro browser authorization first',
      kiroLoginBrowserHint: 'Do not paste tokens or callback data here. Only complete the Builder ID login in the opened browser page.',
      kiroLoginAdvancedImportTitle: 'Advanced import / paste JSON fallback',
      kiroLoginPayload: 'Login Result JSON',
      kiroLoginPayloadPlaceholder: 'Paste Kiro login result JSON containing refresh_token/access_token/profile_arn fields...',
      kiroLoginPayloadHint: 'Nested credentials, external_idp, subscription, and usage fields are supported.',
      kiroLoginPayloadRequired: 'Paste the Kiro login result JSON first',
      kiroLoginPreview: 'Detected Result',
      kiroLoginPreviewButton: 'Preview',
      kiroLoginPreviewFailed: 'Failed to preview Kiro login result',
      kiroLoginImportButton: 'Import from JSON',
      kiroLoginImportSuccess: 'Kiro account imported from JSON',
      kiroLoginCreateButton: 'Create Kiro Account',
      kiroLoginCreateSuccess: 'Kiro account created',
      kiroLoginCreateFailed: 'Failed to create Kiro account',
      kiroApiKeyEntryTitle: 'Kiro API Key',
      kiroApiKeyEntryDesc: 'Create with a ksk_ API key. Tokens are never refreshed.',
      kiroApiKeyLabel: 'Kiro API Key *',
      kiroApiKeyPlaceholder: 'ksk_...',
      kiroApiKeyHint: 'Must start with ksk_. Full key is never shown again after create.',
      kiroApiKeyRequired: 'Please enter a Kiro API Key',
      kiroApiKeyInvalidPrefix: 'Kiro API Key must start with ksk_',
      kiroApiKeyNoRefresh: 'API Key accounts do not support token refresh.',
      kiroEndpoint: 'Endpoint',
      kiroEndpointHint: 'API Key accounts only support the CLI endpoint.',
      kiroApiRegion: 'API Region',
      kiroApiRegionHint: 'Default is us-east-1.',
      ...
      bulkActions: {
        ...
        batchTestFiltered: 'Test Filtered',
        batchTestGroup: 'Test Group',
        batchTestFilteredHint: 'Run health checks on accounts matching the current filters (max 100)',
        editGroup: 'Bulk Edit Group',
        editFilteredHint: 'Update checked fields for accounts in the current filter/group',
      ...
      batchTest: {
        ...
        emptyFilter: 'No accounts match the current filters',
        capped: '{total} account(s) match; testing the first {count} (batch limit)',
        loadFailed: 'Failed to load filtered accounts',
        retryFailed: 'Retest failed accounts',
        deleteFailed: 'Delete failed accounts',
        deleteAllFailed: 'Delete all failed',
        deleteSelectedFailed: 'Delete selected failed',
        deletingFailed: 'Deleting...',
        deleteFailedConfirm: 'Delete the {count} account(s) that failed this health check?',
        selectedFailedCount: 'Selected {selected}/{total} failed account(s)',
        allFailedTab: 'All failed {count}',
        failureTab: '{code} {count}',
        selectFilteredFailed: 'Select current filter',
        selectAllFailed: 'Select all failed',
        invertFailedSelection: 'Invert selection',
        select: 'Select',
        preselectStatus: 'Pre-filter by status before testing',
        preselectStatusHint: '{count} account(s) remain after status filtering',
        proxyOverride: 'Test egress proxy',
        proxyOverrideHint: 'Loaded from IP management. Default keeps each account bound egress (for Grok, if system ops proxy is enabled and nothing is selected here, ops is used). A selection only applies to this batch and does not change account bindings.',
        proxyOverrideKeepBound: 'Keep bound proxy',
        proxyOverrideDirect: 'Force direct (no proxy)',
        proxyOverrideLoadFailed: 'Failed to load proxies; tests can still use each account’s bound proxy',
        proxyOverrideSearch: 'Search proxy name / host',
        ...
        readyCountHint: '{count} account(s) will be tested with the current status filter.',
        grokRiskHint: 'Grok batch tests hit the real upstream. Prefer smaller batches and keep serial spacing for large sets.',
        startConfirm: 'Start health check?\nAccounts: {count}\nEgress: {proxy}\nInterval: {interval}s\nConcurrency: {concurrency}\nMode: {mode}',
        postActionsTitle: 'Actions after testing',
        postActionsHint: 'Apply to the {count} account(s) that passed this health check',
        enableSuccessful: 'Enable successful accounts now',
        activateSuccessful: 'Set successful accounts to active',
        enableSchedulingSuccessful: 'Enable scheduling for successful accounts',
      ...
      bulkEdit: {
        ...
        syncUpstreamHint: 'Fetches the live model catalog from each account upstream and merges it into that account model mapping (adds only, never removes existing models). Each account is processed independently; one failure does not affect the others.',
        syncUpstreamSuccess: 'Synced upstream models for {count} account(s), {added} new model(s) added.',
        syncUpstreamNoChanges: 'All upstream models already exist for {count} account(s); nothing to update.',
        syncUpstreamPartial: 'Sync finished: {success} succeeded, {failed} failed.',
        syncUpstreamFailed: 'Failed to sync upstream models. Please retry later.',
      ...
      account: 'Account',
      testProxyOverride: 'Test egress proxy',
      testProxyOverrideHint: 'Loaded from IP management. Default keeps the account bound egress (for Grok, if system ops proxy is enabled and nothing is selected here, ops is used). A selection only applies to this test and does not change account bindings.',
      testProxyOverrideKeepBound: 'Keep bound proxy',
      testProxyOverrideDirect: 'Force direct (no proxy)',
      testProxyOverrideLoadFailed: 'Failed to load proxies; tests can still use the account bound proxy',
      testProxyOverrideSearch: 'Search proxy name / host',
      testProxyLabel: 'Proxy #{id}',
      ...
      usingEgressIP: 'Egress IP: {ip} ({ms}ms)',
      testDirect: 'Direct (no proxy)',
      egressProbeFailed: 'Egress probe failed: {error}',

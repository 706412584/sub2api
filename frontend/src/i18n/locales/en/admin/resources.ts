export default {
    ...
    proxies: {
      ...
      grokReasoningProbeTitle: 'Grok Visible Reasoning Probe',
      grokReasoningProbeHint: 'Uses any Grok OAuth account credentials and forces egress through the current proxy for a real streaming Responses request. This consumes quota. Only metadata is returned, never summary text.',
      grokReasoningProbeAccount: 'Grok OAuth Account',
      grokReasoningProbeAccountPlaceholder: 'Select a Grok OAuth account for credentials',
      grokReasoningProbeSearchPlaceholder: 'Search by account name (up to 20 results)',
      grokReasoningProbeConfirm: 'I confirm this probe consumes account quota',
      grokReasoningProbeRun: 'Probe Visible Reasoning',
      grokReasoningProbeRunning: 'Probing...',
      grokReasoningProbeLoadAccountsFailed: 'Failed to load Grok OAuth accounts',
      grokReasoningProbeNeedAccount: 'Select a Grok OAuth account first',
      grokReasoningProbeNeedConfirm: 'Confirm quota consumption first',
      grokReasoningProbeDone: 'Probe succeeded: {status}',
      grokReasoningProbeFailed: 'Grok visible reasoning probe failed',
      grokReasoningProbeFailedWithStatus: 'Probe failed: {status}',
      grokReasoningProbeStatus: 'Status',
      grokReasoningProbeVisible: 'Success (visible reasoning)',
      grokReasoningProbeEncrypted: 'Failed (encrypted only)',
      grokReasoningProbeNone: 'Failed (no visible reasoning)',
      grokReasoningProbeError: 'Failed (probe error)',
      grokReasoningProbeChars: 'Visible chars',
      grokReasoningProbeTokens: 'Reasoning tokens',
      grokReasoningProbeLatency: 'Probe latency',
      grokReasoningProbeModel: 'Model',
      grokReasoningProbeAccountUsed: 'Account used',
      grokReasoningProbeMessage: 'Message',
      ...
      pools: {
        create: 'Add Dynamic Pool',
        edit: 'Edit Dynamic Pool',
        delete: 'Delete Dynamic Pool',
        empty: 'No dynamic proxy pools yet. Configure an extract API to pull short-lived IPs into the proxy list.',
        ...
        urlRequired: 'Please enter the extract API URL',
        created: 'Dynamic pool created',
        updated: 'Dynamic pool updated',
        deleted: 'Dynamic pool deleted',
        deleteConfirm: "Delete pool '{name}'? Unbound managed proxies will also be cleaned up.",
        failedToLoad: 'Failed to load dynamic pools',
        failedToSave: 'Failed to save dynamic pool',
        failedToDelete: 'Failed to delete dynamic pool',
        failedToExtract: 'Extract failed',
        extractSuccess: 'Extract done: created {created}, failed {failed}, alive {alive}',
        columns: {
          name: 'Name',
          protocol: 'Protocol',
          alive: 'Alive / Min',
        ...
        form: {
          ...
          extractUrl: 'Extract API URL',
          extractUrlHint: 'Vendor dynamic IP extract link; supports txt / json responses',
          protocol: 'Protocol',
          authMode: 'Auth mode',
          authNone: 'None',
          authFixed: 'Fixed credentials',
          authFromResponse: 'From response',
          username: 'Username',
          password: 'Password',
          responseFormat: 'Response format',
          lineSeparator: 'Line separator',
          ipFieldPath: 'IP field',
          portFieldPath: 'Port field',
        ...
        manageHint: 'Select proxies from the IP list to add to the pool. The entry proxy will randomly pick a pool proxy as egress.',
        loadFromIpList: 'Load from IP list',
        poolProxies: 'Pool proxies',
        ipListProxies: 'IP list',
        ...
        addNodes: 'Add to IP list',
        addNodesSuccess: 'Added {count} nodes to IP list',
        noNodes: 'No nodes. Sync the subscription first.',
        entryProxy: 'Entry Proxy',
        entryProxyStart: 'Start Entry Proxy',
      ...
      subscriptions: {
        ...
        empty: 'No subscription sources yet. Sync will pull nodes into local mihomo and create sidecar-* proxies.',
        searchPlaceholder: 'Search subscriptions...',
        syncNow: 'Sync now',
        desiredCount: '{count} desired nodes',
        sourceUrl: 'Subscription URL',
        sourceInline: 'Pasted body',
        hasInlineBody: 'Inline body saved',
        noInlineBody: 'No inline body',
        statusOk: 'OK',
        statusError: 'Error',
        statusRunning: 'Running',
        statusIdle: 'Idle',
        nameRequired: 'Please enter a name',
        prefixInvalid: 'Name prefix must start with sidecar-',
        urlRequired: 'Please enter a subscription URL',
        inlineRequired: 'Please paste subscription content',
        created: 'Subscription created',
        updated: 'Subscription updated',
        deleted: 'Subscription deleted',
        deleteConfirm: "Delete subscription '{name}'? Sidecar proxies bound to accounts will not be removed.",
        failedToLoad: 'Failed to load subscriptions',
        failedToLoadEngine: 'Failed to load engine status',
        failedToSave: 'Failed to save subscription',
        failedToSync: 'Sync failed',
        failedToDelete: 'Failed to delete subscription',
        syncSummary:
          'Sync done: created {created}, updated {updated}, deleted {deleted}, skipped {skipped}, desired {desired}',
        engineUnknown: 'Engine status unknown',
        engineMissing: 'mihomo/clash-meta binary not found',
        engineMissingHint: 'Install mihomo on PATH, or set PROXY_SUBSCRIPTION_MIHOMO_BINARY.',
        engineRunning: 'mihomo engine running',
        engineIdle: 'mihomo engine idle (no process yet)',
        engineBinary: 'Binary: {path}',
        engineRunningCount: 'Running sources: {count}',
        engineRunningShort: 'Engine running',
        engineSkipped: 'Engine unchanged (same config hash)',
        columns: {
          name: 'Name',
          prefix: 'Prefix',
          ports: 'Ports',
        ...
        form: {
          ...
          urlLeaveEmpty: 'Leave empty to keep current URL',
          currentUrlMasked: 'Current: {url}',
          inlineBody: 'Subscription body',
          inlineLeaveEmpty: 'Leave empty to keep current body',
          inlinePlaceholder: 'Paste Clash YAML or base64 share-link list',
          namePrefix: 'Proxy name prefix',
          namePrefixHint: 'Must start with sidecar-, e.g. sidecar-a-',
          bindAddress: 'Bind address',
          basePort: 'Base port',
          maxPorts: 'Max ports',
          syncInterval: 'Sync interval (sec)',
          syncIntervalHint: 'Min 60, max 86400',

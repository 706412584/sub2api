export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      kiroLoginDesc: 'Paste a single-account Kiro browser-login or kiro-go export JSON. The system will normalize credentials and create a Kiro OAuth account.',
      kiroLoginNamePlaceholder: 'Leave blank to use email or Kiro account name',

export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      kiroLoginPayloadHint: 'Nested credentials, external_idp, subscription, and usage fields are supported. Use “Import Kiro Accounts” for batch data.',
      ...
      grokOAuthTitle: 'Grok OAuth Login',
      grokOAuthButton: 'Grok OAuth Login',
      grokOAuthEntryDesc: 'Create an account with xAI OAuth authorization-code + PKCE.',
      grokOAuthDesc: 'Use the xAI OAuth authorization-code + PKCE flow. Start login, complete authorization in the xAI page, then paste the callback URL or code here to create a Grok OAuth account.',
      grokOAuthNamePlaceholder: 'Leave blank to use xAI account info',
      grokOAuthRedirectUri: 'Redirect URI',
      grokOAuthRedirectUriHint: 'Keep the default. After authorization, the browser may fail to open localhost; copy the full address bar URL back here.',
      grokOAuthStartButton: 'Start Grok Login',
      grokOAuthOpenAgain: 'Open Authorization Page Again',
      grokOAuthStartFailed: 'Failed to generate Grok authorization URL',
      grokOAuthCallbackTitle: 'Paste Authorization Callback',
      grokOAuthCallbackHint: 'After authorization, paste the full callback URL from the browser address bar, or only the code parameter. Do not paste access_token.',
      grokOAuthCallbackPlaceholder: 'http://127.0.0.1:56121/callback?code=...&state=... or paste only code',
      grokOAuthCallbackRequired: 'Paste the Grok authorization callback URL or code first',
      grokOAuthStateMismatch: 'Authorization callback state does not match. Start Grok login again.',
      grokOAuthCreateButton: 'Create Grok Account',
      grokOAuthCreateSuccess: 'Grok account created',
      grokOAuthCreateFailed: 'Grok OAuth login failed',
      grokTokenTitle: 'Grok Manual Token',
      grokTokenButton: 'Grok Manual Token',
      grokTokenEntryDesc: 'Fallback option for pasting an existing Grok/xAI token JSON.',
      grokTokenDesc: 'Paste a single Grok/xAI token JSON payload. The system will normalize supported token fields and create a Grok OAuth account.',
      grokTokenNamePlaceholder: 'Leave blank to use display name, username, email, or subject',
      grokTokenPayload: 'Token JSON',
      grokTokenPayloadPlaceholder: 'Paste JSON containing access_token/accessToken and optional refresh_token, expires_at, api_base_url, user info...',
      grokTokenPayloadHint: 'Supports direct objects and common nested objects such as data.credentials, data.token, and data.user.',
      grokTokenPayloadRequired: 'Paste the Grok token JSON first',
      grokTokenPreview: 'Detected Result',
      grokTokenPreviewButton: 'Preview',
      grokTokenPreviewFailed: 'Failed to preview Grok token payload',
      grokTokenCreateButton: 'Create Grok Account',
      grokTokenCreateSuccess: 'Grok account created',
      grokTokenCreateFailed: 'Failed to create Grok account',
      ...
      grokComingSoon: 'Choose Grok OAuth Login below to create an account. Manual Token is kept as a fallback.',
      grokUseTokenEntry: 'Choose an add method below',
      types: {
        oauth: 'OAuth',
      ...
      bulkActions: {
        ...
        batchScheduledTest: 'Batch Scheduled Test',
        resetStatusSuccess: 'Successfully reset {count} account(s) status',
        refreshTokenSuccess: 'Successfully refreshed {count} account(s) token',
        partialSuccess: 'Partially completed: {success} succeeded, {failed} failed'
      },
      batchTest: {
        title: 'Batch Account Test',
        ...
        deleteAllFailed: 'Delete All Failed Accounts',
        deleteSelectedFailed: 'Delete Selected Failed Accounts',
        deletingFailed: 'Deleting...',
        deleteFailedConfirm: 'Delete {count} account(s) that failed in this test?',
        selectedFailedCount: '{selected}/{total} failed account(s) selected',
        ...
        select: 'Select',
        summary: 'Normal: {success} / Abnormal: {failed}',
      ...
      batchScheduledTest: {
        title: 'Batch Scheduled Test',
        selectedCount: '{count} account(s) selected',
        moreSelected: '{count} more',
        submit: 'Save Scheduled Tests',
        submitting: 'Saving...',
        ...
        // Gemini specific
          ...
          noProjectIdNeededDesc: 'Requires admin-configured OAuth client',
	          ...
	          aiStudioNotConfiguredTip:
	            'AI Studio OAuth is not configured: set GEMINI_OAUTH_CLIENT_ID / GEMINI_OAUTH_CLIENT_SECRET and add Redirect URI: http://127.0.0.1:56121/callback (Consent screen scopes must include https://www.googleapis.com/auth/generative-language.retriever)',
	          aiStudioNotConfigured:
	            'AI Studio OAuth is not configured: set GEMINI_OAUTH_CLIENT_ID / GEMINI_OAUTH_CLIENT_SECRET and add Redirect URI: http://127.0.0.1:56121/callback'
	        },

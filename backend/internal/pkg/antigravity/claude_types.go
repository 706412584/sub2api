...
var geminiModels = []modelDef{
	...
	// gemini-3.8-flash 尚未出现在上游 fetchAvailableModels 返回里（Google 分级放量），
	// 但带档位后缀时可直接调用；裸名由网关按 reasoning effort 自动选档。
	{ID: "gemini-3.8-flash", DisplayName: "Gemini 3.8 Flash", CreatedAt: "2026-08-25T00:00:00Z"},
	{ID: "gemini-3.8-flash-high", DisplayName: "Gemini 3.8 Flash High", CreatedAt: "2026-08-25T00:00:00Z", IsReasoning: true},
	{ID: "gemini-3.8-flash-low", DisplayName: "Gemini 3.8 Flash Low", CreatedAt: "2026-08-25T00:00:00Z", IsReasoning: true},
	{ID: "gemini-3.8-flash-medium", DisplayName: "Gemini 3.8 Flash Medium", CreatedAt: "2026-08-25T00:00:00Z", IsReasoning: true},
	{ID: "gemini-3.8-flash-tiered", DisplayName: "Gemini 3.8 Flash", CreatedAt: "2026-08-25T00:00:00Z", IsReasoning: true},

...
type CreateGroupRequest struct {
	...
	Description               string                        `json:"description"`
	Platform                  string                        `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity grok kiro kimi zhipu deepseek minimax codebuddy opencode_go composite"`

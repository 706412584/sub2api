...
func (m *mockProxyRepoForOAuth) ListOwnedByPrefix(ctx context.Context, namePrefix string) ([]ProxyWithAccountCount, error) {
	panic("ListOwnedByPrefix not implemented")
}

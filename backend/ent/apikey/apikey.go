...
const (
	...
	// EdgeImBots holds the string denoting the im_bots edge name in mutations.
	EdgeImBots = "im_bots"
	...
	// ImBotsTable is the table that holds the im_bots relation/edge.
	ImBotsTable = "im_bots"
	// ImBotsInverseTable is the table name for the IMBot entity.
	// It exists in this package in order to avoid circular dependency with the "imbot" package.
	ImBotsInverseTable = "im_bots"
	// ImBotsColumn is the table column denoting the im_bots relation/edge.
	ImBotsColumn = "api_key_id"
)
...
// ByImBotsCount orders the results by im_bots count.
func ByImBotsCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newImBotsStep(), opts...)
	}
}

// ByImBots orders the results by im_bots terms.
func ByImBots(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newImBotsStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newImBotsStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
		sqlgraph.To(ImBotsInverseTable, FieldID),
		sqlgraph.Edge(sqlgraph.O2M, false, ImBotsTable, ImBotsColumn),
	)
}

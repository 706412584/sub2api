...
func init() {
	...
	groupDescGrokMessagesProtocol := groupFields[54].Descriptor()
	...
	groupDescGrokReasoningVisibilityMode := groupFields[55].Descriptor()
	...
	groupDescGrokReasoningProbeTTLSec := groupFields[56].Descriptor()
	...
	groupDescGrokReasoningQuarantineSec := groupFields[57].Descriptor()

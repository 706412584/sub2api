...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	grokOAuthService := service.ProvideGrokOAuthService(proxyRepository)
	...
	kiroOAuthHandler := admin.NewKiroOAuthHandler(adminService, kiroBuilderIDDeviceFlowService)
	grokOAuthHandler := admin.NewGrokOAuthHandler(adminService, grokOAuthService)
	...
	gitHubReleaseClientFactory := repository.ProvideGitHubReleaseClientFactory(configConfig)
	serviceBuildInfo := provideServiceBuildInfo(buildInfo)
	updateService := service.ProvideUpdateService(updateCache, gitHubReleaseClient, gitHubReleaseClientFactory, settingRepository, configConfig, serviceBuildInfo)

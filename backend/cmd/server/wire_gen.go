...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	grokOAuthService.SetSettingService(settingService)
	...
	openAIGatewayService.SetGrokReasoningQualityMarkStore(grokReasoningQualityMarkStore)
